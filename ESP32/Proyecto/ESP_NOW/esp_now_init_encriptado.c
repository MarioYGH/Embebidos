...
static esp_err_t init_esp_now(void)
{
    ...
    esp_now_set_pmk((const uint8_t*)ESP_NOW_PMK); //Para cifrar data con ESP_now no es sificiente con poner una clave
...
static esp_err_t register_peer(uint8_t *peer_addr)
{
    ...
    //peer_info.lmk = ESP_NOW_LMK; //como es un arreglo de caracteres no se puede igualar directamente
