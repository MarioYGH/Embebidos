...
// Variables globales para el usuario y la contraseña
...
bool verificar_credenciales(const char *usuario, const char *contrasena) {
...
{
    initialize_LED();
    ESP_LOGI(SPP_TAG, "Ingrese su nombre de usuario:");
    char bda_str[18] = {0};
